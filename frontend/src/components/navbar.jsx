export default function Navbar({ openModal , searchNote}) {
    return (
        <div className="flex justify-center p-2 bg-gray-200">
            <div className="flex justify-between max-w-[60rem] w-full gap-4 mx-6">
                <input type="text" placeholder="Search..." onChange={(e)=>searchNote(e.target.value.trim())} className="border py-2 ps-4 w-5/6 rounded-lg outline-none" />
